    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-muted-foreground">Overview of your tracked websites</p>
        </div>
        <button
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <Link
                  ...
                  className="block w-full px-3 py-2 text-sm text-center bg-primary text-primary-foreground rounded hover:opacity-90 transition"
                >
                  View Analytics
                </Link>
              </div>
